...
# App folder
app_dir = '/home/guess/Desktop/autodeploy/examples/demo3/data-eng/'

# Workflows
workflow1 = [
    {'name': 'gathering-20200303143337', 'file': 'gathering.py',
            'env': 'gathering'},

    {'name': 'preprocessing-20200303143337', 'file': 'preprocessing.py',
            'env': 'preprocessing'},

]
workflow2 = [
    {'name': 'modeling-20200303143337', 'file': 'modeling.py',
            'env': 'modeling'},
