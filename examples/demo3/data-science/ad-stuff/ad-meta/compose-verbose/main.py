...
# Workflows
workflow1 = [
    {'name': 'gathering-20200303145458', 'file': 'gathering.py',
            'env': 'gathering'},

    {'name': 'preprocessing-20200303145458', 'file': 'preprocessing.py',
            'env': 'preprocessing'},

]
workflow2 = [
    {'name': 'modeling-20200303145458', 'file': 'modeling.py',
            'env': 'modeling'},
