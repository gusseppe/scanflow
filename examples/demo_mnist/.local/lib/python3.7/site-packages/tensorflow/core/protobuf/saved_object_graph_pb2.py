...
_FUNCTIONSPEC_EXPERIMENTALCOMPILE = _descriptor.EnumDescriptor(
  ...
  full_name='tensorflow.FunctionSpec.ExperimentalCompile',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FUNCTIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experimental_compile', full_name='tensorflow.FunctionSpec.experimental_compile', index=3,
