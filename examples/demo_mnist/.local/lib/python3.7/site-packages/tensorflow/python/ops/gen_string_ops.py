...
def as_string_eager_fallback(input, precision, scientific, shortest, width, fill, name, ctx):
  ...
  if fill is None:
    fill = ""
  fill = _execute.make_str(fill, "fill")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, _dtypes.float32, _dtypes.float64, _dtypes.bool, ])
  _inputs_flat = [input]
