...
def stateless_random_get_key_counter_alg(seed, name=None):
...
def stateless_random_normal_v2(shape, key, counter, alg, dtype=_dtypes.float32, name=None):
...
def stateless_random_uniform_full_int_v2(shape, key, counter, alg, dtype=_dtypes.uint64, name=None):
...
def stateless_random_uniform_int_v2(shape, key, counter, alg, minval, maxval, name=None):
  r"""Outputs deterministic pseudorandom random integers from a uniform distribution.
...
def stateless_random_uniform_v2(shape, key, counter, alg, dtype=_dtypes.float32, name=None):
...
def stateless_truncated_normal_v2(shape, key, counter, alg, dtype=_dtypes.float32, name=None):
