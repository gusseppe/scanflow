...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n5tensorflow/python/keras/protobuf/saved_metadata.proto\x12,third_party.tensorflow.python.keras.protobuf\x1a(tensorflow/core/framework/versions.proto\"Y\n\rSavedMetadata\x12H\n\x05nodes\x18\x01 \x03(\x0b\x32\x39.third_party.tensorflow.python.keras.protobuf.SavedObject\"\x80\x01\n\x0bSavedObject\x12\'\n\x07version\x18\x01 \x01(\x0b\x32\x16.tensorflow.VersionDef\x12\x0f\n\x07node_id\x18\x02 \x01(\x05\x12\x11\n\tnode_path\x18\x03 \x01(\t\x12\x12\n\nidentifier\x18\x04 \x01(\t\x12\x10\n\x08metadata\x18\x05 \x01(\tb\x06proto3')
  ,
...
_SAVEDOBJECT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='third_party.tensorflow.python.keras.protobuf.SavedObject.version', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_id', full_name='third_party.tensorflow.python.keras.protobuf.SavedObject.node_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_path', full_name='third_party.tensorflow.python.keras.protobuf.SavedObject.node_path', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='identifier', full_name='third_party.tensorflow.python.keras.protobuf.SavedObject.identifier', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='third_party.tensorflow.python.keras.protobuf.SavedObject.metadata', index=4,
