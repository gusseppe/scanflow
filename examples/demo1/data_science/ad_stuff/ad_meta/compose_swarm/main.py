...
# App folder
app_dir = '/home/guess/Desktop/autodeploy/examples/demo1/data_science/ad_stuff/ad_meta'

# Workflows
workflow1 = [
    {'name': 'gathering_20191223203424', 'file': 'gathering.py', 
            'env': 'gathering'},

    {'name': 'preprocessing_20191223203424', 'file': 'preprocessing.py', 
            'env': 'preprocessing'}, 

]
workflow2 = [
    {'name': 'modeling_20191223203424', 'file': 'modeling.py', 
            'env': 'modeling'}, 
