...
# App folder
app_dir = '/home/guess/Desktop/autodeploy/examples/demo1/data_eng/ad_stuff/ad_meta'

# Workflows
workflow1 = [
    {'name': 'gathering_20191223211138', 'file': 'gathering.py', 
            'env': 'gathering'},

    {'name': 'preprocessing_20191223211138', 'file': 'preprocessing.py', 
            'env': 'preprocessing'}, 

]
workflow2 = [
    {'name': 'modeling_20191223211138', 'file': 'modeling.py', 
            'env': 'modeling'}, 
