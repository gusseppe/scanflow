...
class Supervisor(Node):
    ...
    def __init__(self,
        ...
        super(Supervisor, self).__init__(name=name)
        # self.mode = mode
    ...
    def choose_port(self, port: int):
        ...
        if self.check_port_in_use(chosen_port):
            logging.info(f"[Supervisor] Port {chosen_port} is in use by Supervisor.")
        else:
            logging.info(f"[Supervisor] Port {chosen_port} is set successfully.")
